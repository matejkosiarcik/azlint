...
git ls-files -z '*.json' '*.geojson' '*.htmlhintrc' '*.babelrc' '*.jsonl' '*.eslintrc.json' '*.jscsrc' '*.jshintrc' '*.jshintrc' 'composer.lock' '*/composer.lock' | xargs -0 jsonlint --quiet --comments
