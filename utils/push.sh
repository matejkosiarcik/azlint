...
if [ "${AZLINT_VERSION}" != 'dev' ]; then
    ...
    docker tag 'matejkosiarcik/azlint-internal:dev-ruby' "matejkosiarcik/azlint-internal:${AZLINT_VERSION}-ruby"
    docker tag 'matejkosiarcik/azlint-internal:dev-rust' "matejkosiarcik/azlint-internal:${AZLINT_VERSION}-rust"
...
docker push "matejkosiarcik/azlint-internal:${AZLINT_VERSION}-ruby"
docker push "matejkosiarcik/azlint-internal:${AZLINT_VERSION}-rust"
