...
bootstrap:
	...
	parallel python3 -m venv ::: build-dependencies/gitman2/venv build-dependencies/yq/venv

	cd "$(PROJECT_DIR)/build-dependencies/gitman2" && \
	...
	PATH="$(PROJECT_DIR)/build-dependencies/gitman2/venv/bin:$(PATH)" \
