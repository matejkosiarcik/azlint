...
RUN gem install bundler && \
    gem update --system && \
    bundle install
FROM debian:testing-20210721 AS ruby
WORKDIR /src
...
FROM debian:testing-20210721 AS circleci
RUN apt-get update && \
...
FROM debian:testing-20210721 AS upx
...
FROM debian:testing-20210721 AS chmod
WORKDIR /src
