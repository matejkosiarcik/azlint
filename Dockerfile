...
RUN gem install bundler && \
    gem update --system && \
    bundle install
FROM debian:testing-20210902 AS ruby
WORKDIR /src
...
FROM debian:testing-20210902 AS circleci
RUN apt-get update && \
...
FROM debian:testing-20210902 AS upx
...
FROM debian:testing-20210902 AS chmod
WORKDIR /src
